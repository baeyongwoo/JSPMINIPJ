   ...
   <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
      <div class="container">
         ...
         <div class="navbar-nav right">
            <ul class="navbar-nav">
               <li class="nav-item"><a class="nav-link" href="/login.do">로그아웃</a>
               </li>
   ...
   <div id="wrapper">
      ...
      <ul
         ...
         <li class="nav-item active"><a class="nav-link"
            href="/adminPage.do"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Dashboard</span></a>
         </li>
         ...
         <li class="nav-item"><a class="nav-link collapsed"
            href="/adminboardlist.do"> <i class="fas fa-fw fa-wrench"></i> <span>BoardList</span>
         </a></li>
         <li class="nav-item"><a class="nav-link collapsed"
                              ...
                              <c:forEach items="${userList}" var="ul">
                                 <tr>
                                    <td><input type="checkbox" name="check"
                                       value="${ul.userId}"
                                       onclick="showPasswordModal(this, '${ul.userId}')"></td>
                                 ...
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                       <button type="button" class="btn btn-primary"
                                          onclick="submitPassword()">확인</button>
                                       <button type="button" class="btn btn-secondary"
                                          data-dismiss="modal" onclick="cancelModal()">취소</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
